...
rm(searchResults)# liberamos memoria
gc()
...
rm(tweetFrame)  #liberamos memoria
gc()
```
...
rm(userFrame) # liberamos memoria
gc()
...
rm(addresses)  #liberamos memoria
gc()
```
...
```{r clear_memory_map, echo=FALSE, cache=FALSE, results = 'asis', message=FALSE, comment=FALSE, warning=FALSE}
...
```{r get_paises_generalizados, echo=FALSE, cache=FALSE, results = 'asis', message=FALSE, comment=FALSE, warning=FALSE, eval=FALSE}
...
```{r save_paises_generalizados, echo=FALSE, cache=FALSE, results = 'asis', message=FALSE, comment=FALSE, warning=FALSE, eval=FALSE}
